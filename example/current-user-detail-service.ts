...
import {UserDetails} from '../src/security/auth/user-details';
import {User} from '../src/security/auth/user';

import {inject, injectbyname} from '../src/di/decorators/inject';
import UserRepository from './tests/repositories/userRepository';
import {UserDetailService} from '../src/security/auth/user-detail-service';
var userRepo: any;
