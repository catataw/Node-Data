  ...
  describe('resolve', () => {
    beforeEach(() => {
      ...
      spyOn(MetaUtils, 'getMetaData').and.callFake((target, decorator) => {
        switch (target) {
          case ServiceB.prototype:
            return [srvBMeta];
          case ServiceC.prototype:
            return [srvC1Meta, srvC2Meta];
          case ServiceD.prototype:
            return [srvD1Meta, srvD2Meta, srvD3Meta];
          case CyclicA.prototype:
            return [srvCycAMeta];
          case CyclicB.prototype:
            return [srvCycBMeta];
          case SrvE.ServiceE.prototype:
            return [srvDefault1Meta, srvDefault2Meta];
          default:
            return [];
        }
      });
